...
CXX_SRCS/Linux=src/rtc_base/file_posix.cc \
               src/rtc_base/synchronization/rw_lock_posix.cc \
...
CXX_SRCS=src/api/audio/audio_frame.cc \
         ...
         src/api/jsep.cc \
         src/api/jsepicecandidate.cc \
         src/api/mediaconstraintsinterface.cc \
         src/api/mediastreaminterface.cc \
         src/api/mediatypes.cc \
         src/api/peerconnectioninterface.cc \
         src/api/proxy.cc \
         src/api/rtcerror.cc \
         src/api/rtp_headers.cc \
         src/api/rtpparameters.cc \
         src/api/rtpreceiverinterface.cc \
         src/api/rtpsenderinterface.cc \
         src/api/rtptransceiverinterface.cc \
         ...
         src/audio/channel_receive_proxy.cc \
         src/audio/channel_send.cc \
         src/audio/channel_send_proxy.cc \
         ...
         src/logging/rtc_event_log/icelogger.cc \
         src/logging/rtc_event_log/output/rtc_event_log_output_file.cc \
         src/logging/rtc_event_log/rtc_event_log2rtp_dump.cc \
         src/logging/rtc_event_log/rtc_event_log2stats.cc \
         src/logging/rtc_event_log/rtc_event_log2text.cc \
         ...
         src/media/base/mediachannel.cc \
         ...
         src/modules/audio_processing/aec3/block_processor2.cc \
         ...
         src/modules/audio_processing/aec3/render_delay_buffer2.cc \
         src/modules/audio_processing/aec3/render_delay_buffer.cc \
         src/modules/audio_processing/aec3/render_delay_controller2.cc \
         ...
         src/modules/audio_processing/aec3/suppression_gain_limiter.cc \
         ...
         src/modules/audio_processing/agc2/fixed_gain_controller.cc \
         src/modules/audio_processing/agc2/gain_applier.cc \
         src/modules/audio_processing/agc2/gain_curve_applier.cc \
         ...
         src/modules/audio_processing/agc2/rnn_vad/fft_util.cc \
         ...
         src/modules/congestion_controller/rtp/pacer_controller.cc \
         src/modules/congestion_controller/rtp/send_side_congestion_controller.cc \
         ...
         src/modules/video_coding/encoder_database.cc \
         ...
         src/p2p/base/basicasyncresolverfactory.cc \
         src/p2p/base/basicpacketsocketfactory.cc \
         src/p2p/base/dtlstransport.cc \
         src/p2p/base/dtlstransportinternal.cc \
         src/p2p/base/icetransportinternal.cc \
         ...
         src/p2p/base/packetsocketfactory.cc \
         src/p2p/base/packettransportinternal.cc \
         src/p2p/base/portallocator.cc \
         src/p2p/base/port.cc \
         src/p2p/base/portinterface.cc \
         src/p2p/base/pseudotcp.cc \
         src/p2p/base/regatheringcontroller.cc \
         ...
         src/pc/jseptransport.cc \
         src/pc/jseptransportcontroller.cc \
         ...
         src/pc/rtcstatstraversal.cc \
         src/pc/rtpmediautils.cc \
         src/pc/rtpparametersconversion.cc \
         src/pc/rtpreceiver.cc \
         src/pc/rtpsender.cc \
         src/pc/rtptransceiver.cc \
         src/pc/rtptransport.cc \
         src/pc/sctputils.cc \
         src/pc/sdputils.cc \
         src/pc/sessiondescription.cc \
         src/pc/srtpfilter.cc \
         src/pc/srtpsession.cc \
         src/pc/srtptransport.cc \
         src/pc/statscollector.cc \
         src/pc/trackmediainfomap.cc \
         src/pc/transportstats.cc \
         ...
         src/rtc_base/bitrateallocationstrategy.cc \
         src/rtc_base/bufferqueue.cc \
         src/rtc_base/bytebuffer.cc \
         src/rtc_base/cancelable_task_handle.cc \
         ...
         src/rtc_base/experiments/congestion_controller_experiment.cc \
         ...
         src/rtc_base/fakeclock.cc \
         src/rtc_base/fakesslidentity.cc \
         src/rtc_base/file.cc \
         src/rtc_base/filerotatingstream.cc \
         ...
         src/rtc_base/opensslcertificate.cc \
         src/rtc_base/openssldigest.cc \
         src/rtc_base/opensslidentity.cc \
         src/rtc_base/opensslsessioncache.cc \
         src/rtc_base/opensslstreamadapter.cc \
         src/rtc_base/opensslutility.cc \
         ...
         src/rtc_base/sslcertificate.cc \
...
RNNOISE_SRCS=src/third_party/rnnoise/src/kiss_fft.cc \
