    ...
    : remote_ssrc_(config.rtp.remote_ssrc),
      ...
      rtp_rtcp_(env,
                {.audio = false,
                 ...
                 .rtcp_loss_notification_observer = nullptr,
                 .network_link_rtcp_observer = nullptr,
                 .network_state_estimate_observer = nullptr,
                 .transport_feedback_callback = nullptr,
                 .bitrate_allocation_observer = nullptr,
                 .rtt_stats = rtt_stats,
                 .rtcp_packet_type_counter_observer = nullptr,
                 .rtcp_cname_callback = nullptr,
                 .report_block_data_observer = nullptr,
                 .paced_sender = nullptr,
                 .fec_generator = nullptr,
                 .send_bitrate_observer = nullptr,
                 .send_packet_observer = nullptr,
                 .retransmission_rate_limiter = nullptr,
                 .rtp_stats_callback = nullptr,
                 .rtcp_report_interval_ms = 0,
                 .populate_network2_timestamp = false,
                 .frame_transformer = nullptr,
                 .frame_encryptor = nullptr,
                 .require_frame_encryption = false,
                 .extmap_allow_mixed = false,
                 .always_send_mid_and_rid = false,
